...
Launch.display();
  stoneS.display() 
  detectCollision(m1,stoneS);
  detectCollision(m2,stoneS);
  detectCollision(m3,stoneS);
  detectCollision(m4,stoneS);
  detectCollision(m5,stoneS);
  detectCollision(m6,stoneS);
  detectCollision(m7,stoneS);
